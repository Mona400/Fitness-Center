...
namespace FitnessCenter.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.UserType = new SelectList(db.Roles/*.Where(a => !a.Name.Contains("Owner")).ToList()*/, "Name", "Name");
            return View();
        }
        ...
        public ActionResult EditProfile(EditProfileViewModel profile)
        {
            if (profile != null && profile.UserName != null)
            {
                ...
                {
                    ViewBag.Message = "الباسورد الحالي غير صحيح..!";
                }
                else
                {
                    ...
                    db.SaveChanges();
                    ViewBag.Message = "تم تحديث بيانات الحساب بنجاج";
                    return RedirectToAction("Index", "Home");
